...
class PreprocessingLayer(Layer):
  ...
  def __init__(self, 
    ...
    self.default_embed_size = default_embed_size
    ...
    for col_index, col in enumerate(self.all_columns):
      if col in self.cat_columns:
        ...
        if col in self.embeddings:
          ...
          cat_representation = tf.squeeze(self.embeddings[col](cat_feature))
  ...
  def get_config(self) -> Dict:
    ...
    return {**base_config,
            ...
            "default_embed_size": self.default_embed_size,
